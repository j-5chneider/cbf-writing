---
title: "Computer-based feedback on writing quality"
author:
...
* Definition feedback [Jü]
  - Fokus auf computer-based (nicht peer, nicht mediiert)
  - Fokus auf feedback on writing
  - Modell [evtl. nach unten?]
* Aktueller Forschungsstand [Sa]
  - AVs (Feedback auf was)
  - wie Feedback?
  - Tools
  - Bedarf an Feedback (Relevanz) Petition against automated scoring systems: http://humanreaders.org/petition/research_findings.htm signatures still until 2020
* Research gap: [Jü]
  - Systematisierung der Forschung, Begriffe/ Konzepte und ...
...
[Sa]
* Advancements of computer-based feedback in the last 10 years (sinde 2003?
* mapping the landscape concerning
  - what (Patchan, Schunn & Correnti)
  - with smol additions of: focus of feedback (Hattie)
* further directions
...
## Eligibility: Inclusion and Exclusion Criteria [Sa]
...
* Population: 
  ...
  - L1 (first language)
  - years: 2003 and younger: MYaccess established (uses intellimetric), Project Essay Grade updated, summary street?, e-rater?
* Intervention: 
...
* Intervention: 
  ...
  - summative feedback
  - delayed feedback
  - teacher feedback using computer tools
...
## Sources of Search: List and Rationale [Jü]
